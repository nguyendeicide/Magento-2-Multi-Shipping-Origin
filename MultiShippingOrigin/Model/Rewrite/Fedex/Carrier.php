...
namespace Acidpos\MultiShippingOrigin\Model\Rewrite\Fedex;
...
class Carrier extends \Magento\Fedex\Model\Carrier
{
    ...
    public function setRequest(RateRequest $request)
    {
        ...
        if ( $this->isMultiShippingOriginEnabled($request) 
            && $this->isMultiShippingOriginEnabledForFedex($request)
            ...
            /* replacing origin shipping - FedEX only uses country and postcode for calculate */
    ...
    public function isMultiShippingOriginEnabledForFedex($request){
        ...
        return in_array("fedex", $arrayMethods);
    }   
